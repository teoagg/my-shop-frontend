...
export default async function StoreComparison() {
  ...
  if (!report) return <section className="mt-8 rounded-lg border border-[var(--line)] bg-white p-5"><h2 className="text-2xl font-black">Σύγκριση με WooCommerce</h2><p className="mt-3">Δεν έχει δημοσιευτεί ολοκληρωμένη συγκριτική μέτρηση.</p></section>
  ...
  return (
    <section id="woocommerce-comparison" className="mt-8 rounded-lg border border-[var(--line)] bg-white p-5 sm:p-7">
      ...
      <details open className="mt-4 rounded-lg border border-[var(--line)] p-4"><summary className="cursor-pointer font-bold">Μεθοδολογία και όρια ερμηνείας</summary><ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6"><li>Μία προθέρμανση ανά URL εκτός στατιστικών και 10 μετρήσεις. Εναλλαγή σειράς των συστημάτων, παύση ενός δευτερολέπτου, χωρίς παράλληλες αιτήσεις ή εκκαθάριση cache.</li><li>Python urllib, ανώνυμο GET, επαλήθευση TLS, ακολούθηση ανακατευθύνσεων και identity encoding. Οι χρόνοι δεν συγκρίνονται απευθείας με το ξεχωριστό report Node.js από το Plesk.</li><li>Σε 10 δείγματα το P95 nearest-rank ισούται με τη μέγιστη επιτυχημένη τιμή. Οι αποτυχίες εμφανίζονται χωριστά.</li><li>Και τα δύο καταστήματα έχουν 10 δημοσιευμένα προϊόντα, αλλά διαφορετικά προϊόντα, εικόνες και templates. Το WooCommerce διατηρεί 181 drafts και προϊόντα με παραλλαγές.</li><li>Στην αρχική Next.js καταγράφηκε cache HIT. Το WP Super Cache εμφάνιζε σφάλμα permalinks πριν τη μέτρηση. Δεν έχουν επαληθευτεί οι διαθέσιμοι πόροι και κάθε επίπεδο cache του hosting.</li><li>Τα αποτελέσματα αφορούν αυτές τις εγκαταστάσεις. Δεν αποδεικνύουν γενική υπεροχή πλατφόρμας ή ικανότητα κλιμάκωσης υπό φορτίο.</li></ul></details>
      <div className="mt-5 grid gap-5 md:grid-cols-2"><div><h3 className="font-bold">Κόστος — ποιοτική σύγκριση</h3><p className="mt-2 text-sm leading-6">WooCommerce: hosting, συντήρηση και ενδεχόμενες άδειες θέματος/προσθέτων. Headless: hosting Next.js/Strapi, χρήση AWS και συντήρηση διασυνδέσεων. Δεν παρουσιάζονται προσωπικές χρεώσεις ή συμπέρασμα για τη φθηνότερη λύση.</p></div><div><h3 className="font-bold">Επέκταση λειτουργιών</h3><p className="mt-2 text-sm leading-6">Το WooCommerce επεκτείνεται με πρόσθετα και hooks. Η headless εγκατάσταση χρησιμοποιεί API και ανεξάρτητες υπηρεσίες. Η σύγκριση αυτή είναι αρχιτεκτονική, όχι αποτέλεσμα δοκιμής φόρτου.</p></div></div>
