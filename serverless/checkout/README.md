...
Endpoint: `POST /checkout`. Default port: `8789`. `GET /health` checks the service process; it does not check Strapi connectivity. Hosting environment variables take precedence over `.env`.
